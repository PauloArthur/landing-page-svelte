	...
	const firstPod = [
		{
			...
			description:
				'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nisi dolor, tincidunt id mauris non, tristique aliquet magna. Morbi consectetur eu ipsum ut vestibulum.',
			image: podImage1
		}
	];
